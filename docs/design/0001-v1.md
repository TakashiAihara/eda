...
- Known limit: map.md has no file lock. An editor that saves in the few milliseconds between eda reading map.md and writing it back loses that save (it is neither applied nor a candidate).
